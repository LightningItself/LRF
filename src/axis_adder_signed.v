...
module axis_adder_signed #(
    parameter DATA_WIDTH = 16
)(
    input aclk,
    input aresetn,
    input signed [DATA_WIDTH-1:0] s_axis_tdata_x,
    input                          s_axis_tvalid_x,
    output                         s_axis_tready_x,
    input                          s_axis_tlast_x,
    input signed [DATA_WIDTH-1:0] s_axis_tdata_y,
    input                          s_axis_tvalid_y,
    output                         s_axis_tready_y,
    input                          s_axis_tlast_y,
    input signed [DATA_WIDTH-1:0] s_axis_tdata_z,
