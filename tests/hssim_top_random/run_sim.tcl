set TEST_NAME "hssim_top_random"
set SRC_DIR "../src"
...
add_files -fileset sim_1 ${TEST_DIR}/tb_hssim_top.sv
set_property file_type SystemVerilog [get_files ${TEST_DIR}/tb_hssim_top.sv]

set_property include_dirs $WORKSPACE_DIR [get_filesets sim_1]

# Adding test data 
add_files -fileset sim_1 $INPUT_HEX_OLD $INPUT_HEX_AVG $INPUT_HEX_NEW $OUTPUT_HEX_PACKED
...
-value "-testplusarg IN_FILE_NAME_OLD=$ABS_INPUT_HEX_OLD -testplusarg IN_FILE_NAME_AVG=$ABS_INPUT_HEX_AVG -testplusarg IN_FILE_NAME_NEW=$ABS_INPUT_HEX_NEW -testplusarg OUT_FILE_NAME_PACKED=$ABS_OUTPUT_HEX_PACKED" \
