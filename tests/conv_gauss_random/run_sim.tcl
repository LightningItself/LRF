set TEST_NAME "conv_gauss_random"
set SRC_DIR "../src"
...
add_files -fileset sim_1 ${TEST_DIR}/tb_conv_gauss.sv
set_property file_type SystemVerilog [get_files ${TEST_DIR}/tb_conv_gauss.sv]
